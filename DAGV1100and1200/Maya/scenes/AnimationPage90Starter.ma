...
//Last modified: Tue, Jan 27, 2026 11:17:33 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "41EC6D71-4B38-3797-8BAF-C7A3EA94BF74";
...
createNode transform -n "pSphere1";
	rename -uid "22C42252-42EE-39FD-3A25-F283764F17E1";
	setAttr ".t" -type "double3" 0 3.2026624582274668 6.1454155701064348 ;
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "FCFCDEF6-4764-D223-611F-99957405FA64";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4FDEDD91-4EDE-B9D4-1481-0E820F320952";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "80CE1BFB-48DA-0675-A86D-3ABCA7DF94A8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3E1FDC93-4F7B-1476-6BF5-7394D257C358";
createNode displayLayerManager -n "layerManager";
	rename -uid "BF5374EA-425E-5EC8-4EF5-89917D647B2D";
createNode displayLayer -n "defaultLayer";
	rename -uid "138E985A-7348-29D9-3700-8797FCF8ABC7";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A538DF65-4305-D635-2C95-73A145C64F32";
...
createNode polySphere -n "polySphere1";
	rename -uid "99ABF1BE-4F0E-4B5C-E0AB-2DA1AAC1F632";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
