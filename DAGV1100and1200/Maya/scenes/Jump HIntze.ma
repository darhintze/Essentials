...
//Name: Jump HIntze.ma
//Last modified: Fri, Apr 17, 2026 11:43:47 PM
//Codeset: 1252
...
fileInfo "UUID" "450C7FF6-4665-9DB2-B16F-C381DC4708A3";
createNode transform -s -n "persp";
	rename -uid "A99A115B-2B40-A95A-EB94-24A6C71E6B67";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.402870445294107 7.9395084834067449 18.640634766681359 ;
	setAttr ".r" -type "double3" -8.1383527295900375 -36.599999999220714 -4.952175898815361e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "23F191FC-AA4C-36B2-3112-5F83AEC65EF3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 23.359409522878227;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "93C4E4A8-4C29-6DBB-2AC7-E0B6C67D2D3A";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6438933C-4294-AFE4-996E-718B8050AF3A";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7C033C42-4788-DAD5-5EAB-D2A045913CBE";
createNode displayLayerManager -n "layerManager";
	rename -uid "3399EA3C-493C-D2FF-12D7-5C9AC0929684";
createNode displayLayer -n "defaultLayer";
	rename -uid "AD86C33F-B446-9A72-33B8-0B9D3BFC2C83";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A9FAD7C1-4534-331D-FE33-72BF61D6BB51";
