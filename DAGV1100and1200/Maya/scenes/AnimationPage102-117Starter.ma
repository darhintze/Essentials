...
//Last modified: Mon, Feb 02, 2026 06:51:01 PM
//Codeset: 1252
...
fileInfo "UUID" "83012F2D-464B-DC0D-EFEF-46B05EFBAB8B";
createNode transform -s -n "persp";
	rename -uid "C9712CCD-754C-F86E-AD2A-73826B605734";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.136905868216278 4.0640734970947587 0.18724502676887056 ;
	setAttr ".r" -type "double3" -17.738352729573151 89.399999999971513 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "461DA5EF-F84A-C499-F69E-15ADE383DA43";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 8.543530683925999;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B818A065-41B8-F167-B4EF-8FAE9172FC71";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "72B7E132-4AB9-5408-5C07-ED983D47B8FD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "33AF4B11-43CE-C761-7F18-11BECB88A581";
createNode displayLayerManager -n "layerManager";
	rename -uid "EBDAF834-4F0F-8A21-DDB5-75A8A7349D93";
createNode displayLayer -n "defaultLayer";
	rename -uid "AC91CB9A-E140-CD7A-D861-648C94E9970F";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "34AA0B41-4E0C-BAB2-296D-F3818BCE2311";
...
createNode reference -n "Ultimate_Walker_IK_v1_0_1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -0.51857726471674648 -0.093940379217390291 1.52388727045441197"
