...
//Last modified: Sat, Apr 11, 2026 02:51:24 PM
//Codeset: 1252
...
fileInfo "UUID" "08F53614-433E-6667-E14C-6E90A1D7B3A5";
createNode transform -s -n "persp";
	rename -uid "B94D4494-44D4-303D-A219-C1BA0DFBE4D0";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.459230812225645 12.00395280268725 23.336738191660125 ;
	setAttr ".r" -type "double3" -20.738352729603115 42.600000000000833 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "99230320-465E-46D7-23B7-C498633001AD";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 33.899805594833254;
...
createNode reference -n "shipRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		5 4 "shipRN" "|ship:ship|ship:collider.visibility" "shipRN.placeHolderList[11]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.translateZ" "shipRN.placeHolderList[12]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.translateX" "shipRN.placeHolderList[13]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.translateY" "shipRN.placeHolderList[14]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.rotateX" "shipRN.placeHolderList[15]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.rotateY" "shipRN.placeHolderList[16]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.rotateZ" "shipRN.placeHolderList[17]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.scaleX" "shipRN.placeHolderList[18]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.scaleY" "shipRN.placeHolderList[19]" 
		""
		5 4 "shipRN" "|ship:ship|ship:collider.scaleZ" "shipRN.placeHolderList[20]" 
		""
		5 3 "shipRN" "|ship:ship|ship:collider|ship:colliderShape.worldMesh" 
		"shipRN.placeHolderList[21]" ""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.translateZ" "shipRN.placeHolderList[22]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.translateX" "shipRN.placeHolderList[23]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.translateY" "shipRN.placeHolderList[24]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.visibility" "shipRN.placeHolderList[25]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.rotateX" "shipRN.placeHolderList[26]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.rotateY" "shipRN.placeHolderList[27]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.rotateZ" "shipRN.placeHolderList[28]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.scaleX" "shipRN.placeHolderList[29]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.scaleY" "shipRN.placeHolderList[30]" 
		""
		5 4 "shipRN" "|ship:ship|ship:shipGeo.scaleZ" "shipRN.placeHolderList[31]" 
		"";
...
createNode animCurveTL -n "ship_translateX";
	rename -uid "3A3CC063-49E9-514A-1A8C-67920F4F3E41";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0 80 0;
createNode animCurveTL -n "ship_translateY";
	rename -uid "DDFD0CB1-4E41-4FC8-4A60-EB8C65D556C0";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0 80 0;
createNode animCurveTL -n "ship_translateZ";
	...
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -13.642216798827725 80 6.6889837223398647;
createNode animCurveTU -n "ship_visibility";
	rename -uid "7150F7A4-4919-811A-4939-048D703175DB";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "ship_rotateY";
	rename -uid "0CBD815A-4CA6-9E20-E7C2-6CAE6F1F608F";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0 80 0;
...
createNode animCurveTU -n "ship_scaleX";
	rename -uid "3548AD0F-4D80-FA71-62C7-20B15B28F446";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 1 80 1;
createNode animCurveTU -n "ship_scaleY";
	rename -uid "C6DE2132-4394-AE4E-0F88-E0AB9D4BAE59";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 1 80 1;
createNode animCurveTU -n "ship_scaleZ";
	rename -uid "433BAE4B-4A03-6169-351D-D39FFDFB7B1E";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 1 80 1;
...
connectAttr "collider_visibility.o" "shipRN.phl[11]";
connectAttr "collider_translateZ.o" "shipRN.phl[12]";
connectAttr "collider_translateX.o" "shipRN.phl[13]";
connectAttr "collider_translateY.o" "shipRN.phl[14]";
connectAttr "collider_rotateX.o" "shipRN.phl[15]";
connectAttr "collider_rotateY.o" "shipRN.phl[16]";
connectAttr "collider_rotateZ.o" "shipRN.phl[17]";
connectAttr "collider_scaleX.o" "shipRN.phl[18]";
connectAttr "collider_scaleY.o" "shipRN.phl[19]";
connectAttr "collider_scaleZ.o" "shipRN.phl[20]";
connectAttr "shipRN.phl[21]" "BossGeoProperties1.inMesh";
connectAttr "shipGeo_translateZ.o" "shipRN.phl[22]";
connectAttr "shipGeo_translateX.o" "shipRN.phl[23]";
connectAttr "shipGeo_translateY.o" "shipRN.phl[24]";
connectAttr "shipGeo_visibility.o" "shipRN.phl[25]";
connectAttr "shipGeo_rotateX.o" "shipRN.phl[26]";
connectAttr "shipGeo_rotateY.o" "shipRN.phl[27]";
connectAttr "shipGeo_rotateZ.o" "shipRN.phl[28]";
connectAttr "shipGeo_scaleX.o" "shipRN.phl[29]";
connectAttr "shipGeo_scaleY.o" "shipRN.phl[30]";
connectAttr "shipGeo_scaleZ.o" "shipRN.phl[31]";
...
connectAttr "BossOutputShape.iog" ":initialShadingGroup.dsm" -na;
