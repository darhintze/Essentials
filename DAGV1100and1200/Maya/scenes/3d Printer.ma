...
//Name: 3d Printer.ma
//Last modified: Mon, Mar 09, 2026 02:23:00 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "FBAB0EB6-4EFA-3602-BD97-21835F16D45C";
createNode transform -s -n "persp";
	rename -uid "F3F12A60-4FDA-E01A-7E58-EC8031F0B813";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.965504395382915 3.8196585557351121 -2.1019272617416092 ;
	setAttr ".r" -type "double3" -13.799999999998734 461.99999999967832 0 ;
	setAttr ".rpt" -type "double3" 7.1015829060917118e-17 8.9112974173692251e-17 2.1525943999415359e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E3DCB2CA-4BAD-6F81-C6E7-2482C8C116C0";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 8.7610028832656983;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -3.547648841362333e-09 1.3630440779188566 -5.3214734563412928e-09 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "38FCCA11-4901-A6A5-EB20-FB85C16ABEA3";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "56A5D27C-4AD9-64ED-F39C-69A3EB709EAA";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9A46C168-4EF1-4461-523A-DF93B69C28C3";
createNode displayLayerManager -n "layerManager";
	rename -uid "D8FC73E6-49E4-3A8A-FD1C-A2AA3441D0AB";
createNode displayLayer -n "defaultLayer";
	rename -uid "31607F0B-4F0B-0AD5-D71F-AE8D09972222";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F32CE43A-41BB-E161-6A0E-A1B3688DAECE";
